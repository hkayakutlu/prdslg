	...
	public void itemStateChanged(ItemEvent itemEvent) {
	  ...
	  public void mouseClicked(MouseEvent e) {
			...
			if(model.getValueAt(i, 11) != null){
			 ...
			 if(model.getValueAt(i, 9).toString().equalsIgnoreCase("Мероприятия")){
    		  ...
    		  }else if(model.getValueAt(i, 9).toString().equalsIgnoreCase("Реклама")){  
				  if(model.getValueAt(i, 12) != null){
    		  ...
    		  }else if(model.getValueAt(i, 9).toString().equalsIgnoreCase("POS-материалы")){
    			  if(model.getValueAt(i, 12) != null){
