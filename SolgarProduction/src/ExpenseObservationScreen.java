...
public class ExpenseObservationScreen extends JFrame implements ActionListener,ItemListener,MouseListener{
	...
	public JButton btnSearch,btnReject,btnUpdate,btnSave,btnExit;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ExpenseObservationScreen window = new ExpenseObservationScreen(inBag);
	 ...
	 */
	public ExpenseObservationScreen(ESIBag inBag) {
	...
	public void actionPerformed(ActionEvent e) {
		try {
			if (e.getActionCommand().equals("Search")) {
				...
				ConnectToDb.getExpsWithParameters(resultTable,cmbBoxCountry,cmbBoxRegion,cmbBoxCompanyCode,cmbBoxExpMain,cmbBoxExpLevel1,cmbBoxExpLevel2,
						cmbBoxsearchEventDateSmall,cmbBoxsearchEventDateBig,cmbBoxsearchEntryDateSmall,cmbBoxsearchEntryDateBig);					
