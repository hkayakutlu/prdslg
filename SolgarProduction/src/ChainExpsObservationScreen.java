...
public class ChainExpsObservationScreen extends JFrame implements ActionListener,ItemListener,MouseListener{
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					ChainExpsObservationScreen frame = new ChainExpsObservationScreen(inBag);
	 ...
	 * @throws SQLException 
	 */
	public ChainExpsObservationScreen(ESIBag inBag) throws SQLException {
		super("Chain Expense Observation");
		Toolkit toolkit;
		Dimension dim;
		...
		pnlStage.setBounds(356, 277, 797, 139);
		...
		fmtxTotPaySum.setEnabled(false);
		...
		fmtxPurchasingSum.setEnabled(false);
		...
		fmtxPurchasingAmount.setEnabled(false);
		...
		fmtxSellOutSum.setEnabled(false);
		...
		fmtxSellAmountAmount.setEnabled(false);
		...
		txtPaymentOrderNo.setEnabled(false);
		...
		cmbBoxDocumentStatus.setEnabled(false);
		...
		fmtxOutgoingAmount.setEnabled(false);
		...
		pnlBonusRate.setBounds(10, 277, 336, 139);
		...
		tblBonusRates.setModel(new DefaultTableModel(
			new Object[][] {
				{null, "CHAIN BONUS", new Integer(0), new Integer(0), new Short((short) 0), new Integer(0)},
				{null, "PHARMACIST BONUS", new Integer(0), new Integer(0), new Short((short) 0), new Integer(0)},
				{null, "PHARMACY MANAGER BONUS", new Integer(0), new Integer(0), new Short((short) 0), new Integer(0)},
			},
			new String[] {
			...
			Class[] columnTypes = new Class[] {
				Integer.class, Object.class, Integer.class, Integer.class, Short.class, Integer.class
			};
			public Class getColumnClass(int columnIndex) {
				return columnTypes[columnIndex];
			}
		...
		pnlResult.setBounds(20, 427, 1133, 198);
